...
public class VentanaEjercicio1 extends JFrame {
	...
	public VentanaEjercicio1() {
		...
		setBounds(100, 100, 382, 262);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		GridBagLayout gbl_contentPane = new GridBagLayout();
		gbl_contentPane.columnWidths = new int[]{0, 0, 0, 160, 0};
		...
		btnMostrar.addMouseListener(new EventoMouse());
		...
		gbc_lblDatosIngresados.gridwidth = 3;
