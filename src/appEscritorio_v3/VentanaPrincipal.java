...
public class VentanaPrincipal extends JFrame implements Ventana {
	...
	public VentanaPrincipal() {
		...
		btnEjercicio1.addActionListener(new AdministradorDeEventos(0));
		...
		btnEjercicio2.addActionListener(new AdministradorDeEventos(1));
		...
		btnEjercicio3.addActionListener(new AdministradorDeEventos(2));
	...
	// Metodos
	protected int getNumeroVentana() {
		return numeroVentana;
	}
	protected void setNumeroVentana(int numeroVentana) {
